...
try{
	...
	stmt = con.prepareStatement("Select * FROM critics GROUP BY 1,2");
	ResultSet rs = stmt.executeQuery();
	out.println("<form action=\"del_critic\"><table id=\"container\"><tr><th>User</th><th>Restaurant</th><th>Vote</th><th>Critic</th></tr>");
		while(rs.next())
		{
			 out.println("<tr>");
	         ...
	         %>
				...
				<input type="hidden" name="juror_name" value="<%out.println(rs.getString("username"));%>"/>
